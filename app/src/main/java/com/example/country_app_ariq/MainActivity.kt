...
class MainActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnShowCustomDialog = findViewById<Button>(R.id.btn_show_alert_dialog)
        ...
        with(binding) {
            ...
            // DatePicker biasa yang ada di activity_main.xml
            datePicker.init(
                datePicker.year,
                datePicker.month,
            ...
            // TimePicker biasa yang ada di activity_main.xml
